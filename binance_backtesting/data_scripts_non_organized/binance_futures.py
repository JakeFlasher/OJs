...
BASE_URL = "https://data.binance.vision/data/futures/um/daily/liquidationSnapshot/BTCUSDT/"
OUTPUT_DIR = "binance_liqudation_futures_zips"
...
while current_date <= end_date:
    ...
    zip_filename = f"BTCUSDT-liquidationSnapshot-{date_str}.zip"
