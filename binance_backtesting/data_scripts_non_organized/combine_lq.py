...
Each zip file (named "BTCUSDT-1d-YYYY-MM-DD.zip") is assumed to contain one CSV.
...
zip_folder = "binance_liqudation_futures_zips"
# Output CSV file name
output_csv = "liquid_BTCUSDT_1d.csv"
...
# Expected filename: BTCUSDT-1d-YYYY-MM-DD.zip
pattern = re.compile(r"BTCUSDT-liquidationSnapshot-(\d{4}-\d{2}-\d{2})\.zip")
...
if dataframes:
    ...
    combined_df.sort_values(by=["file_date", "time"], inplace=True)
